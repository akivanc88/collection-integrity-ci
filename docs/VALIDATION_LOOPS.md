...
| --- | --- | --- | --- |
| VL-01 | Benchmark closure | Rule-engine correctness | partial (10 rules at P=R=1.0) |
...
| VL-06 | Test-strength (mutation) | The test suite itself | active (found+closed 7 real gaps to date) |
