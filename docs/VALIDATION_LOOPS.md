...
| --- | --- | --- | --- |
| VL-01 | Benchmark closure | Rule-engine correctness | pending (Phase 3) |
| VL-02 | Fingerprint determinism | Finding identity/baselines | partial |
...
| VL-06 | Test-strength (mutation) | The test suite itself | active |
