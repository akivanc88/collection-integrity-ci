...
| --- | --- | --- | --- |
| VL-01 | Benchmark closure | Rule-engine correctness | partial (CORE001/CORE002 pass at P=R=1.0) |
...
| VL-06 | Test-strength (mutation) | The test suite itself | active (7/7 mutants killed) |
